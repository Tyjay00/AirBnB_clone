...
# This script contains three unittest classes: 
# TestReview_instantiation, TestReview_save, and TestReview_to_dict.
# These classes contain test methods that check various aspects of the Review class
